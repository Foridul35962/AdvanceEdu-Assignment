export const generateVerificationMail = (email, otp) => {
  return {
    ...
    to: email,
    subject: 'Welcome to Advance Edu 🎉',
    html: `
      <div style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 20px;">
        <div style="max-width: 500px; margin: auto; background: white; border-radius: 10px; padding: 20px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
          <h2 style="color: #007bff; text-align: center;">Welcome to Advance Edu</h2>
          ...
          <p style="font-size: 13px; color: #888; text-align: center;">
            © ${new Date().getFullYear()} AdvanceEdu Project. All rights reserved.
          </p>
        </div>
      </div>
    `
    ...
    html: `
      <div style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 20px;">
        <div style="max-width: 500px; margin: auto; background: white; border-radius: 10px; padding: 20px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
          ...
          <hr style="margin: 20px 0; border: none; border-top: 1px solid #ddd;">
          <p style="font-size: 13px; color: #888; text-align: center;">
            © ${new Date().getFullYear()} Addvance Edu Project. All rights reserved.
          </p>
        </div>
      </div>
    `
